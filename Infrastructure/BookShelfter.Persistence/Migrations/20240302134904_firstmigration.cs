    ...
    public partial class firstmigration : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BookProductImageFile", x => new { x.BooksId, x.ProductImageFilesId });
                    table.ForeignKey(
                        name: "FK_BookProductImageFile_Books_BooksId",
                        column: x => x.BooksId,
                        principalTable: "Books",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_BookProductImageFile_ProductImageFiles_ProductImageFilesId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BookProductImageFile_ProductImageFilesId",
                table: "BookProductImageFile",
